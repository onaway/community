...
var processENV = env.envs//'prod';
console.log('build env:',processENV)
...
/*    new HtmlWebpackPlugin({
    ...
    new CopyWebpackPlugin([
      {
        from: path.resolve(__dirname, '../static/'+env.appName),
...
for(var i in entrys){
  module.exports.plugins.push(new HtmlWebpackPlugin(entrys[i]));
