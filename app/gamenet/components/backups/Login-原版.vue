            ...
            <ul>
                <li class="tel" v-if="showLogin">
                    <div class="wrapper">
                        <div class="input-box">
                            <i class="icon-user"></i>
                            <input type="tel" v-model="telForm.phone" placeholder="手机号" maxlength="11">
                        </div>
                        <div>
                ...
                <li class="huandong" v-else>
                    <div class="wrapper">
                        ...
                        <div class="psd-box input-box">
                            <i class="icon-psd"></i>
                            <input class="input-psw" type="password" v-model="hdForm.password" @keyup.enter="hdLogin" placeholder="密码">
                        </div>
                        <div class="password">
...
export default {
    ...
    methods: {
        ...
        submitAccount: function(){          //欢动账号登录
            ...
            var password = this.hdForm.password;
